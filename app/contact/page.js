                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        {services.map((service, index) => (
                          <option key={index} value={service.value} className="py-2">
                            {service.name}
                          </option>
                        ))}
                      </select>
        ...
        <div className="mt-20">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Find quick answers to common questions about our services and properties.
            </p>
          </div>
            ...
            {[
              {
                ...
                answer: "We typically respond to all inquiries within 24 hours during business days. For urgent matters, we have emergency contact numbers available."
              },
              {
                question: "Do you offer virtual property tours?",
                answer: "Yes! We provide virtual tours and video calls for all our properties, making it easy to explore from anywhere in the world."
              },
              {
                question: "What areas do you specialize in?",
                answer: "We focus on premium properties in Miami, South Florida, and select international markets. Our expertise covers luxury homes, investment properties, and commercial real estate."
              },
              {
                question: "Can you help with financing options?",
                answer: "Absolutely! We work with trusted financial partners and can guide you through various financing options, including traditional mortgages and investment loans."
              }
            ].map((faq, index) => (

          ...
          <div className='sm:hidden py-4 space-y-4'>
            ...
            <div className='border-t border-white/20 pt-3'>
              ...
              {open.company && (
                <ul className='mt-3 space-y-2'>
                  <li>
                    <Link href='/about' className='hover:text-[#B59A3D]'>
                      {t('about')}
                    </Link>
                  </li>
                  <li>
                    <Link href='/services' className='hover:text-[#B59A3D]'>
                      {t('services')}
                    </Link>
                  </li>
                </ul>
            ...
            <div className='border-t border-white/20 pt-3'>
              ...
              {open.legal && (
                <ul className='mt-3 space-y-2'>
                  <li>
                    <Link href='/site-notice' className='hover:text-[#B59A3D]'>
                      {t('siteNotice')}
                    </Link>
                  </li>
                  <li>
                    <Link href='/terms' className='hover:text-[#B59A3D]'>
                      {t('terms')}
                    </Link>
                  </li>
                  <li>
                ...
                <ul className='mt-3 space-y-2'>
                  <li>
                    ...
                    >
                      ...
                      <span>
                        Carrer de Ametler 3 – 1B, ES-07609 Llucmajor, <br />{' '}
                  ...
                  <li>
                    <a
                      ...
                      className='hover:text-[#B59A3D] inline-flex items-center gap-2'
                    >

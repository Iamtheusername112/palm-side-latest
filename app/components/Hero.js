...
const Hero = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      title: 'Mallorcas finest beaches',
    ...
    },
    {
      ...
      alt: 'Stylish Terraces',
      title: 'Stylish Terraces',
    ...
    {
      type: 'image',
      src: '/heroimages/wohnzimmer2.jpeg',
      alt: 'Modern Living Rooms',
      title: 'Modern Living Rooms',
      titleKey: 'hero.stylishLivingRooms',
      subtitle: 'Elegant interiors for relaxed living',
      subtitleKey: 'hero.elegantInteriors',
      description: 'Comfort and luxury in perfect harmony.',
      descriptionKey: 'hero.livingDescription',
    ...
    {
      type: 'image',
      src: '/heroimages/Villaeingang.jpeg',
    ...
    {
      type: 'image',
      src: '/heroimages/wellnessarea.jpeg',

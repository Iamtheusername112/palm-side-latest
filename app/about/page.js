      ...
      <section className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
        <div className='grid grid-cols-1 gap-12 items-center'>
          ...
          <div className='order-1'>
            ...
            <p className='text-gray-700 leading-relaxed mb-4 text-lg xl:text-xl'>
            ...
            <p className='text-gray-700 leading-relaxed text-lg xl:text-xl'>
      ...
      <section className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8'>
          ...
          <div className='bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow p-8 flex flex-col items-center text-center'>
            ...
            <h3 className='text-lg xl:text-xl font-semibold text-gray-900'>Jeanette Bakacak</h3>
            <p className='text-lg xl:text-xl text-gray-600 mb-4'>Founder/CEO</p>
            <div className='space-y-1 text-gray-700 mb-4 text-lg xl:text-xl'>
              <p>
                <span className='inline-flex items-center gap-2'>
                  <Phone className='w-4 h-4 text-[#B59A3D]' />
              ...
              <p>
                <a href='mailto:info@palmside.es' className='hover:text-[#B59A3D] inline-flex items-center gap-2'>
                  <Mail className='w-4 h-4 text-[#B59A3D]' />
            ...
            <p className='text-gray-700 leading-relaxed text-lg xl:text-xl mt-3'>
          ...
          <div className='bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow p-8 flex flex-col items-center text-center'>
            ...
            <h3 className='text-lg xl:text-xl font-semibold text-gray-900'>Claudia Launer</h3>
            <p className='text-lg xl:text-xl text-gray-600 mb-4'>Consulting</p>
            <div className='space-y-1 text-gray-700 mb-4 text-lg xl:text-xl'>
              <p>
                <span className='inline-flex items-center gap-2'>
                  <Phone className='w-4 h-4 text-[#B59A3D]' />
                  <span>+49 1573 4903876</span>
                </span>
              </p>
              <p>
                <a href='mailto:consulting@palmside.es' className='hover:text-[#B59A3D] inline-flex items-center gap-2'>
                  <Mail className='w-4 h-4 text-[#B59A3D]' />
                  <span>consulting@palmside.es</span>
                </a>
              </p>
            </div>
            <p className='text-gray-700 leading-relaxed text-lg xl:text-xl'>
          ...
          <div className='bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow p-8 flex flex-col items-center text-center'>
            ...
            <h3 className='text-lg xl:text-xl font-semibold text-gray-900'>Taner Bakacak</h3>
            <p className='text-lg xl:text-xl text-gray-600 mb-4'>Technical Director</p>
            <div className='space-y-1 text-gray-700 mb-4 text-lg xl:text-xl'>
              <p>
                <span className='inline-flex items-center gap-2'>
                  <Phone className='w-4 h-4 text-[#B59A3D]' />
              ...
              <p>
                <a href='mailto:technical@palmside.es' className='hover:text-[#B59A3D] inline-flex items-center gap-2'>
                  <Mail className='w-4 h-4 text-[#B59A3D]' />
                  <span>technical@palmside.es</span>
                </a>
              </p>
            </div>
            <p className='text-gray-700 leading-relaxed text-lg xl:text-xl'>
            ...
            <p className='text-gray-700 leading-relaxed text-lg xl:text-xl mt-3'>
              At Palmside S.L., I combine precision, efficiency, and a problem-solving mindset to deliver top-tier technical results – reliably and at scale.
            </p>
          </div>
        </div>

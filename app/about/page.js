      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 gap-12 items-center">
          <div className="lg:col-span-5 order-2 lg:order-2">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">{t('story.p1')}</p>
            <p className="text-gray-700 leading-relaxed mb-4">{t('story.p2')}</p>
            <p className="text-gray-700 leading-relaxed mb-4">{t('story.p3')}</p>
            <p className="text-gray-700 leading-relaxed">{t('story.p4')}</p>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow p-8 flex flex-col items-center text-center">
            ...
            <div className="space-y-1 text-base text-gray-700 mb-4">
              <p>
                <span className="font-medium">{t('team.labels.phone')}</span> —
              </p>
              <p>
          ...
          <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow p-8 flex flex-col items-center text-center">
            ...
            <div className="space-y-1 text-base text-gray-700 mb-4">
              ...
              <p>
                <span className="font-medium">{t('team.labels.email')}</span>{' '}
                <a
                  href="mailto:consulting@palmside.es"
                  className="hover:text-[#B59A3D]"
                >

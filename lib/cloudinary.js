...
if (!CLOUDINARY_CLOUD_NAME || !CLOUDINARY_API_KEY || !CLOUDINARY_API_SECRET) {
  ...
  if (!CLOUDINARY_CLOUD_NAME) console.error('  - CLOUDINARY_CLOUD_NAME is missing')
  if (!CLOUDINARY_API_KEY) console.error('  - CLOUDINARY_API_KEY is missing')
  if (!CLOUDINARY_API_SECRET) console.error('  - CLOUDINARY_API_SECRET is missing')

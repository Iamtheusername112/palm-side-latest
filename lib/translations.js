...
export const translations = {
  en: {
    ...
    // Footer
    'footer.copyright': '© 2024 Palmside S.L.. All rights reserved.',
    ...
    'legal.complianceDescription':
      'Company identification and legal information in compliance with LSSI-CE.',
    'legal.lssiCompliance': 'In compliance with LSSI-CE',
    'legal.companyIdentification': '1. Company Identification',
    'legal.intellectualProperty': '2. Intellectual Property',
    'legal.useOfWebsite': '3. Use of the Website',
    'legal.liability': '4. Liability',
    'legal.applicableLaw': '5. Applicable Law and Jurisdiction',
    'legal.contact': '6. Contact',
    'legal.lastUpdated': 'Last updated:',
    'legal.lssiDescription':
      'In compliance with Law 34/2002, of July 11, on Services of the Information Society and Electronic Commerce (LSSI-CE), the following information is provided.',
    'legal.companyName': 'Company name:',
    'legal.tradeName': 'Trade name:',
    'legal.managingDirector': 'Managing Director:',
    'legal.registeredOffice': 'Registered office:',
    'legal.cifNif': 'CIF/NIF:',
    'legal.commercialRegistry': 'Commercial Registry:',
    'legal.registeredInRegistry':
      'Registered in the Commercial Registry of Palma de Mallorca, Volume [XXX], Sheet [XXX], Page [XXX]',
    'legal.phone': 'Phone:',
    'legal.email': 'Email:',
    'legal.address': 'Address:',
    'legal.intellectualPropertyDescription':
      'All content on this website (texts, images, logos, designs, software, etc.) is the exclusive property of Palmside S.L. or its legitimate owners. The reproduction, distribution, or modification of such content without prior written authorization is strictly prohibited.',
    'legal.useOfWebsiteDescription':
      'Users agree to use this website in accordance with the law, this Legal Notice, and good faith. The use of the website for purposes that may damage the rights or interests of third parties, or that may in any way harm or impede its normal operation, is strictly prohibited.',
    'legal.liabilityDescription':
      'Palmside S.L. is not responsible for the misuse of the contents of its website, nor for damages or losses arising from access, use, or misuse of the information. The company is also not responsible for the legality of other third-party websites that may be accessed from this site.',
    'legal.applicableLawDescription':
      'This Legal Notice is governed by Spanish law. Any dispute related to this website will be submitted to the Courts and Tribunals of Palma de Mallorca, with the express waiver of any other jurisdiction that may apply.',
    'legal.contactDescription':
    ...
    'privacy.dataController': 'Who We Are (Data Controller)',
    'privacy.lastUpdated': 'Last updated:',
    'privacy.dataControllerDescription':
      'This Privacy Policy describes how Palmside S.L. ("we", "us", "our") collects and processes your personal data when you use our website and app or contact us. Palmside S.L. is the data controller responsible for your personal data.',
    'privacy.company': 'Company:',
    'privacy.registeredAddress': 'Registered address:',
    'privacy.phone': 'Phone:',
    'privacy.email': 'Email:',
    'privacy.address': 'Address:',
    'privacy.informationWeCollect': '1. Information We Collect',
    'privacy.informationWeCollectDescription':
      'We collect information you provide directly to us when you submit the contact form, call us, or email us. This may include:',
    'privacy.nameSurname': 'Name and surname',
    'privacy.emailAddress': 'Email address',
    'privacy.phoneNumber': 'Phone number',
    'privacy.messageContent': 'Message content and subject of inquiry',
    'privacy.propertyPreferences':
      'Optional property preferences or requirements you decide to share',
    'privacy.howWeUseInformation': '2. How We Use Your Information',
    'privacy.weUseInformationTo': 'We use your information to:',
    'privacy.respondToInquiries':
      'Respond to your inquiries sent via the contact form, phone, or email',
    'privacy.provideInformation':
      'Provide requested information about properties and services',
    'privacy.improveWebsite': 'Improve our website/app and customer support',
    'privacy.complyLegal': 'Comply with legal and regulatory obligations',
    'privacy.doNotSell': 'We do not sell your personal data.',
    'privacy.legalBases': '3. Legal Bases (GDPR)',
    'privacy.legalBasesDescription':
    ...
    'privacy.legitimateInterests': 'Legitimate interests',
    'privacy.legitimateInterestsDescription':
      'to respond to your inquiries and operate our business.',
    'privacy.legalObligation': 'Legal obligation',
    'privacy.legalObligationDescription':
      'where processing is necessary to comply with applicable laws.',
    'privacy.informationSharing': '4. Information Sharing',
    'privacy.informationSharingDescription':
      'We do not sell your personal information. We may share your information only as necessary:',
    'privacy.serviceProviders':
      'With trusted service providers (e.g., hosting, email delivery) acting as processors',
    'privacy.requiredByLaw':
      'When required by law, court order, or public authority',
    'privacy.corporateTransactions':
      'In connection with corporate transactions (merger, acquisition) subject to safeguards',
    'privacy.explicitConsent': 'With your explicit consent',
    'privacy.dataRetention': '5. Data Retention',
    'privacy.dataRetentionDescription':
      'We retain your personal data only for as long as necessary to respond to your inquiry and for a reasonable period thereafter to maintain records and comply with legal obligations. We delete or anonymize data when it is no longer needed.',
    'privacy.dataSecurity': '6. Data Security',
    ...
    'privacy.internationalTransfersDescription':
      'If personal data is transferred outside the EU/EEA, we will ensure appropriate safeguards are in place (e.g., EU Standard Contractual Clauses) and that your rights remain protected.',
    'privacy.yourRights': '8. Your Rights (GDPR)',
    'privacy.youHaveRightTo': 'You have the right to:',
    'privacy.accessUpdate': 'Access and update your personal information',
    'privacy.requestDeletion': 'Request deletion of your personal information',
    'privacy.optOutMarketing': 'Opt-out of marketing communications',
    'privacy.requestCopy': 'Request a copy of your data',
    'privacy.withdrawConsent': 'Withdraw consent at any time',
    'privacy.restrictObject':
      'Restrict or object to processing in certain circumstances',
    'privacy.exerciseRights': 'To exercise your rights, contact us at',
    'privacy.lodgeComplaint':
    ...
    'privacy.cookiesTracking': '9. Cookies and Tracking',
    'privacy.cookiesTrackingDescription':
      'We use cookies and similar tracking technologies to enhance your experience on our website. You can control cookie settings through your browser preferences.',
    'privacy.contactUs': '10. Contact Us',
    'privacy.contactUsDescription':
      'If you have any questions about this Privacy Policy, please contact us:',
    'privacy.changesToPolicy': '11. Changes to This Policy',
    'privacy.changesToPolicyDescription':
    ...
    'terms.companyDetails': 'Company Details',
    'terms.lastUpdated': 'Last updated:',
    'terms.company': 'Company:',
    'terms.registeredAddress': 'Registered address:',
    'terms.phone': 'Phone:',
    'terms.email': 'Email:',
    'terms.acceptanceOfTerms': '1. Acceptance of Terms',
    'terms.acceptanceDescription':
      'By accessing and using Palmside S.L. services, you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.',
    'terms.descriptionOfService': '2. Description of Service',
    'terms.descriptionOfServiceText':
      'Palmside S.L. provides real estate services including but not limited to:',
    'terms.propertySales': 'Property sales and purchases',
    'terms.investmentConsulting': 'Investment consulting',
    'terms.propertyManagement': 'Property management',
    'terms.marketAnalysis': 'Market analysis',
    'terms.legalSupport': 'Legal support and guidance',
    'terms.userResponsibilities': '3. User Responsibilities',
    'terms.userResponsibilitiesText':
      'As a user of our services, you agree to:',
    'terms.provideAccurateInfo': 'Provide accurate and complete information',
    'terms.lawfulPurposes': 'Use our services only for lawful purposes',
    'terms.respectRights': 'Respect the rights of other users',
    'terms.noFraudulent': 'Not engage in fraudulent or deceptive practices',
    'terms.complyLaws': 'Comply with all applicable laws and regulations',
    'terms.propertyInformation': '4. Property Information',
    'terms.propertyInformationText':
      'While we strive to provide accurate property information, we cannot guarantee the completeness or accuracy of all property details. Property information is subject to change without notice. We recommend:',
    'terms.verifyDetails': 'Verifying all property details independently',
    'terms.conductInspections': 'Conducting your own inspections',
    'terms.consultAdvisors': 'Consulting with legal and financial advisors',
    'terms.reviewContracts': 'Reviewing all contracts carefully',
    'terms.limitationOfLiability': '5. Limitation of Liability',
    'terms.limitationDescription':
      'Palmside S.L. shall not be liable for any direct, indirect, incidental, special, or consequential damages resulting from the use or inability to use our services, including but not limited to:',
    'terms.propertyValueFluctuations': 'Property value fluctuations',
    'terms.marketConditions': 'Market conditions',
    'terms.thirdPartyActions': 'Third-party actions or omissions',
    'terms.technicalIssues': 'Technical issues or service interruptions',
    'terms.intellectualProperty': '6. Intellectual Property',
    'terms.intellectualPropertyDescription':
      'All content on this website is the property of Palmside S.L. or used with permission. Reproduction or distribution without written authorization is prohibited.',
    'terms.privacyPolicy': '7. Privacy Policy',
    'terms.privacyPolicyDescription':
      'Your privacy is important to us. Our collection and use of personal information is governed by our Privacy Policy, which is incorporated into these Terms of Service by reference and complies with the EU General Data Protection Regulation (GDPR).',
    'terms.termination': '8. Termination',
    'terms.terminationDescription':
      'We reserve the right to terminate access to our services without notice if you violate these terms.',
    'terms.governingLaw': '9. Governing Law',
    'terms.governingLawDescription':
      'These Terms of Service are governed by and construed in accordance with the laws of Spain and applicable European Union law. Any disputes shall be subject to the exclusive jurisdiction of the courts of Palma de Mallorca, Spain.',
    'terms.contactInformation': '10. Contact Information',
    'terms.contactInformationDescription':
      'If you have questions about these Terms of Service, please contact us:',
    'terms.changesToTerms': '11. Changes to Terms',
    'terms.changesToTermsDescription':
      'We reserve the right to modify these Terms of Service at any time. Continued use of our services after such changes constitutes your acceptance of the new terms.',

    // Additional Terms translations for sections 6-11
    'terms.intellectualPropertyText':
      'All content, trademarks, and intellectual property on this website are owned by Palmside S.L. or our licensors. You may not:',
    'terms.noCopyContent':
      'Copy, modify, or distribute our content without permission',
    'terms.noUseTrademarks':
      'Use our trademarks or logos without authorization',
    'terms.noReverseEngineer':
      'Reverse engineer or attempt to extract source code',
    'terms.noRemoveNotices': 'Remove copyright or proprietary notices',
    'terms.privacyDataProtection': '7. Privacy and Data Protection',
    'terms.privacyDataProtectionText':
      'Your privacy is important to us. Our collection and use of personal information is governed by our Privacy Policy, which is incorporated into these Terms of Service by reference and complies with the EU General Data Protection Regulation (GDPR).',
    ...
    'terms.governingLawText':
      'These Terms of Service are governed by and construed in accordance with the laws of Spain and applicable European Union law. Any disputes shall be subject to the exclusive jurisdiction of the courts of Palma de Mallorca, Spain.',
    'terms.contactInformationText':
      'If you have any questions about these Terms of Service, please contact us:',
    'terms.address': 'Address:',
    'terms.changesToTermsText':
    ...
    'hero.endlessCoastlines': 'Mallorcas finest beaches',
    ...
    'hero.terracePool': 'Outside pools',
    ...
    'hero.stylishInterior': 'Stylish Interiors',
    'hero.stylishLivingRooms': 'Modern Living Rooms',
    ...
    'about.story2':
      "After years of helping people navigate the island's property market, we founded  Palmside to combine our professional expertise with our genuine love for this incredible place.",
    'about.story3':
    ...
    'about.visionText':
      'To be the leading real estate company in Mallorca, recognized for our innovation, integrity, and exceptional client outcomes. We envision a future where real estate investment is accessible, profitable, and rewarding for everyone.',
    ...
    'about.jeanettePosition': 'Founder/CEO',
    'about.jeanetteBio':
      "I'm a bridge builder between people, markets, and opportunities – with over 30 years of experience in two worlds: international wholesale and the real estate industry. I've built academies, served clients worldwide, coordinated construction projects, managed commercial properties, and managed homeowners' associations and retirement communities. My drive? Optimizing processes, connecting people, and making every project a success – with heart, mind, and a keen eye for detail.",
    'about.claudiaPosition': 'Consulting',
    'about.claudiaBio':
    ...
    'properties.showFilters': 'Show Filters',
    'properties.hideFilters': 'Hide Filters',
    ...
    'properties.tryAgain': 'Try Again',

    // Property details modal
    'properties.description': 'Description',
    'properties.bedrooms': 'Bedrooms',
    'properties.bathrooms': 'Bathrooms',
    'properties.squareFeet': 'Square Feet',
    'properties.yearBuilt': 'Year Built',
    'properties.additionalDetails': 'Additional Details',
    'properties.lotSize': 'Lot Size',
    'properties.featuresAmenities': 'Features & Amenities',
    'properties.interestedInProperty': 'Interested in this property?',
    'properties.contactAgent': 'Contact Agent',
    'properties.sendInquiry': 'Send Inquiry',
    'properties.propertyId': 'Property ID',
    'properties.listedOn': 'Listed on',
    ...
    'contact.officeDescription': 'Our office in Son Verí Nou, Mallorca',
  ...
  de: {
    ...
    // Footer
    'footer.copyright': '© 2024 Palmside S.L.. Alle Rechte vorbehalten.',
    ...
    'legal.complianceDescription':
      'Firmenidentifikation und rechtliche Informationen gemäß LSSI-CE.',
    'legal.lssiCompliance': 'In Übereinstimmung mit LSSI-CE',
    'legal.companyIdentification': '1. Firmenidentifikation',
    'legal.intellectualProperty': '2. Geistiges Eigentum',
    'legal.useOfWebsite': '3. Nutzung der Website',
    'legal.liability': '4. Haftung',
    'legal.applicableLaw': '5. Anwendbares Recht und Gerichtsstand',
    'legal.contact': '6. Kontakt',
    'legal.lastUpdated': 'Zuletzt aktualisiert:',
    'legal.lssiDescription':
      'In Übereinstimmung mit dem Gesetz 34/2002 vom 11. Juli über Dienstleistungen der Informationsgesellschaft und des elektronischen Handels (LSSI-CE) werden die folgenden Informationen bereitgestellt.',
    'legal.companyName': 'Firmenname:',
    'legal.tradeName': 'Handelsname:',
    'legal.managingDirector': 'Geschäftsführer:',
    'legal.registeredOffice': 'Registrierter Sitz:',
    'legal.cifNif': 'CIF/NIF:',
    'legal.commercialRegistry': 'Handelsregister:',
    'legal.registeredInRegistry':
      'Eingetragen im Handelsregister von Palma de Mallorca, Band [XXX], Blatt [XXX], Seite [XXX]',
    'legal.phone': 'Telefon:',
    'legal.email': 'E-Mail:',
    'legal.address': 'Adresse:',
    'legal.intellectualPropertyDescription':
      'Alle Inhalte dieser Website (Texte, Bilder, Logos, Designs, Software usw.) sind ausschließliches Eigentum von Palmside S.L. oder deren rechtmäßigen Eigentümern. Die Reproduktion, Verbreitung oder Modifikation solcher Inhalte ohne vorherige schriftliche Genehmigung ist strengstens untersagt.',
    'legal.useOfWebsiteDescription':
      'Benutzer stimmen zu, diese Website in Übereinstimmung mit dem Gesetz, diesem Impressum und dem guten Glauben zu nutzen. Die Nutzung der Website für Zwecke, die die Rechte oder Interessen Dritter schädigen oder deren normalen Betrieb beeinträchtigen könnten, ist strengstens untersagt.',
    'legal.liabilityDescription':
      'Palmside S.L. ist nicht verantwortlich für den Missbrauch der Inhalte ihrer Website oder für Schäden oder Verluste, die durch Zugriff, Nutzung oder Missbrauch der Informationen entstehen. Das Unternehmen ist auch nicht verantwortlich für die Rechtmäßigkeit anderer Websites Dritter, die von dieser Website aus zugänglich sind.',
    'legal.applicableLawDescription':
      'Dieses Impressum unterliegt spanischem Recht. Jede Streitigkeit im Zusammenhang mit dieser Website wird den Gerichten und Tribunalen von Palma de Mallorca unterworfen, mit ausdrücklichem Verzicht auf jede andere möglicherweise anwendbare Gerichtsbarkeit.',
    'legal.contactDescription':
      'Für Fragen oder rechtliche Anfragen können Sie uns kontaktieren unter:',

    // Privacy Policy
    'privacy.privacyPolicy': 'Datenschutz',
    'privacy.privacyDescription':
      'Ihre Privatsphäre ist uns wichtig. Erfahren Sie, wie wir Ihre Informationen sammeln, verwenden und schützen.',
    'privacy.dataController':
      'Wer wir sind (Verantwortlicher für Datenverarbeitung)',
    'privacy.lastUpdated': 'Zuletzt aktualisiert:',
    'privacy.dataControllerDescription':
      'Diese Datenschutzerklärung beschreibt, wie Palmside S.L. ("wir", "uns", "unser") Ihre personenbezogenen Daten sammelt und verarbeitet, wenn Sie unsere Website und App nutzen oder uns kontaktieren. Palmside S.L. ist der für Ihre personenbezogenen Daten verantwortliche Verantwortliche.',
    'privacy.company': 'Unternehmen:',
    'privacy.registeredAddress': 'Registrierte Adresse:',
    'privacy.phone': 'Telefon:',
    'privacy.email': 'E-Mail:',
    'privacy.address': 'Adresse:',
    'privacy.informationWeCollect': '1. Informationen, die wir sammeln',
    'privacy.informationWeCollectDescription':
      'Wir sammeln Informationen, die Sie uns direkt zur Verfügung stellen, wenn Sie das Kontaktformular ausfüllen, uns anrufen oder uns eine E-Mail senden. Dies kann umfassen:',
    'privacy.nameSurname': 'Vor- und Nachname',
    'privacy.emailAddress': 'E-Mail-Adresse',
    'privacy.phoneNumber': 'Telefonnummer',
    'privacy.messageContent': 'Nachrichteninhalt und Betreff der Anfrage',
    'privacy.propertyPreferences':
      'Optionale Immobilienpräferenzen oder Anforderungen, die Sie teilen möchten',
    'privacy.howWeUseInformation': '2. Wie wir Ihre Informationen verwenden',
    'privacy.weUseInformationTo': 'Wir verwenden Ihre Informationen für:',
    'privacy.respondToInquiries':
      'Beantwortung Ihrer Anfragen über das Kontaktformular, Telefon oder E-Mail',
    'privacy.provideInformation':
      'Bereitstellung angeforderten Informationen über Immobilien und Dienstleistungen',
    'privacy.improveWebsite':
      'Verbesserung unserer Website/App und Kundensupport',
    'privacy.complyLegal':
      'Einhaltung rechtlicher und regulatorischer Verpflichtungen',
    'privacy.doNotSell': 'Wir verkaufen Ihre personenbezogenen Daten nicht.',
    'privacy.legalBases': '3. Rechtsgrundlagen (DSGVO)',
    'privacy.legalBasesDescription':
      'Wir verarbeiten Ihre personenbezogenen Daten auf Grundlage der folgenden Rechtsgrundlagen (DSGVO Art. 6):',
    'privacy.consent': 'Einwilligung',
    'privacy.consentDescription':
      'wenn Sie das Kontaktformular ausfüllen oder einen Rückruf anfordern.',
    'privacy.legitimateInterests': 'Berechtigte Interessen',
    'privacy.legitimateInterestsDescription':
      'um auf Ihre Anfragen zu antworten und unser Geschäft zu betreiben.',
    'privacy.legalObligation': 'Rechtliche Verpflichtung',
    'privacy.legalObligationDescription':
      'wenn die Verarbeitung zur Einhaltung geltender Gesetze erforderlich ist.',
    'privacy.informationSharing': '4. Informationsweitergabe',
    'privacy.informationSharingDescription':
      'Wir verkaufen Ihre persönlichen Informationen nicht. Wir können Ihre Informationen nur nach Bedarf teilen:',
    'privacy.serviceProviders':
      'Mit vertrauenswürdigen Dienstleistern (z.B. Hosting, E-Mail-Versand) als Auftragsverarbeiter',
    'privacy.requiredByLaw':
      'Wenn dies gesetzlich vorgeschrieben, durch Gerichtsbeschluss oder öffentliche Behörde erforderlich ist',
    'privacy.corporateTransactions':
      'Im Zusammenhang mit Unternehmensgeschäften (Fusion, Übernahme) unter Einhaltung von Schutzmaßnahmen',
    'privacy.explicitConsent': 'Mit Ihrer ausdrücklichen Zustimmung',
    'privacy.dataRetention': '5. Datenspeicherung',
    'privacy.dataRetentionDescription':
      'Wir speichern Ihre personenbezogenen Daten nur so lange, wie es zur Beantwortung Ihrer Anfrage und für einen angemessenen Zeitraum danach zur Aufrechterhaltung von Aufzeichnungen und Einhaltung rechtlicher Verpflichtungen erforderlich ist. Wir löschen oder anonymisieren Daten, wenn sie nicht mehr benötigt werden.',
    'privacy.dataSecurity': '6. Datensicherheit',
    'privacy.dataSecurityDescription':
      'Wir implementieren angemessene Sicherheitsmaßnahmen zum Schutz Ihrer persönlichen Informationen vor unbefugtem Zugriff, Änderung, Offenlegung oder Zerstörung. Jedoch ist keine Übertragungsmethode über das Internet 100% sicher.',
    'privacy.internationalTransfers': '7. Internationale Datenübertragungen',
    'privacy.internationalTransfersDescription':
      'Wenn personenbezogene Daten außerhalb der EU/EWR übertragen werden, stellen wir sicher, dass angemessene Schutzmaßnahmen vorhanden sind (z.B. EU-Standardvertragsklauseln) und dass Ihre Rechte geschützt bleiben.',
    'privacy.yourRights': '8. Ihre Rechte (DSGVO)',
    'privacy.youHaveRightTo': 'Sie haben das Recht:',
    'privacy.accessUpdate':
      'Zugriff auf und Aktualisierung Ihrer persönlichen Informationen',
    'privacy.requestDeletion':
      'Löschung Ihrer persönlichen Informationen zu beantragen',
    'privacy.optOutMarketing': 'Widerspruch gegen Marketing-Kommunikation',
    'privacy.requestCopy': 'Eine Kopie Ihrer Daten anzufordern',
    'privacy.withdrawConsent': 'Ihre Einwilligung jederzeit zu widerrufen',
    'privacy.restrictObject':
      'Die Verarbeitung unter bestimmten Umständen einzuschränken oder zu widersprechen',
    'privacy.exerciseRights':
      'Um Ihre Rechte auszuüben, kontaktieren Sie uns unter',
    'privacy.lodgeComplaint':
      'Sie haben auch das Recht, eine Beschwerde bei Ihrer örtlichen Datenschutzbehörde einzureichen. In Spanien ist dies die Agencia Española de Protección de Datos (AEPD).',
    'privacy.cookiesTracking': '9. Cookies und Tracking',
    'privacy.cookiesTrackingDescription':
      'Wir verwenden Cookies und ähnliche Tracking-Technologien, um Ihre Erfahrung auf unserer Website zu verbessern. Sie können Cookie-Einstellungen über Ihre Browser-Einstellungen kontrollieren.',
    'privacy.contactUs': '10. Kontaktieren Sie uns',
    'privacy.contactUsDescription':
      'Wenn Sie Fragen zu dieser Datenschutzerklärung haben, kontaktieren Sie uns bitte:',
    'privacy.changesToPolicy': '11. Änderungen an dieser Richtlinie',
    'privacy.changesToPolicyDescription':
    ...
    // Terms of Service
    'terms.termsOfService': 'Nutzungsbedingungen',
    'terms.termsDescription':
      'Bitte lesen Sie diese Bedingungen sorgfältig durch, bevor Sie unsere Dienstleistungen nutzen.',
    'terms.companyDetails': 'Firmendetails',
    'terms.lastUpdated': 'Zuletzt aktualisiert:',
    'terms.company': 'Unternehmen:',
    'terms.registeredAddress': 'Registrierte Adresse:',
    'terms.phone': 'Telefon:',
    'terms.email': 'E-Mail:',
    'terms.acceptanceOfTerms': '1. Annahme der Bedingungen',
    'terms.acceptanceDescription':
      'Durch den Zugriff auf und die Nutzung der Palmside S.L. Dienstleistungen akzeptieren und stimmen Sie zu, an die Bedingungen und Bestimmungen dieser Vereinbarung gebunden zu sein. Wenn Sie nicht zustimmen, sich an das oben Genannte zu halten, nutzen Sie bitte diesen Service nicht.',
    'terms.descriptionOfService': '2. Beschreibung des Services',
    'terms.descriptionOfServiceText':
      'Palmside S.L. bietet Immobiliendienstleistungen an, einschließlich, aber nicht beschränkt auf:',
    'terms.propertySales': 'Immobilienverkäufe und -käufe',
    'terms.investmentConsulting': 'Investmentberatung',
    'terms.propertyManagement': 'Immobilienverwaltung',
    'terms.marketAnalysis': 'Marktanalyse',
    'terms.legalSupport': 'Rechtliche Unterstützung und Beratung',
    'terms.userResponsibilities': '3. Benutzerverantwortlichkeiten',
    'terms.userResponsibilitiesText':
      'Als Nutzer unserer Dienstleistungen stimmen Sie zu:',
    'terms.provideAccurateInfo':
      'Genaue und vollständige Informationen bereitzustellen',
    'terms.lawfulPurposes':
      'Unsere Dienstleistungen nur für rechtmäßige Zwecke zu nutzen',
    'terms.respectRights': 'Die Rechte anderer Nutzer zu respektieren',
    'terms.noFraudulent':
      'Sich nicht an betrügerischen oder täuschenden Praktiken zu beteiligen',
    'terms.complyLaws': 'Alle geltenden Gesetze und Vorschriften einzuhalten',
    'terms.propertyInformation': '4. Immobilieninformationen',
    'terms.propertyInformationText':
      'Während wir uns bemühen, genaue Immobilieninformationen bereitzustellen, können wir nicht die Vollständigkeit oder Genauigkeit aller Immobiliendetails garantieren. Immobilieninformationen können ohne Vorankündigung geändert werden. Wir empfehlen:',
    'terms.verifyDetails': 'Alle Immobiliendetails unabhängig zu überprüfen',
    'terms.conductInspections': 'Eigene Inspektionen durchzuführen',
    'terms.consultAdvisors': 'Rechts- und Finanzberater zu konsultieren',
    'terms.reviewContracts': 'Alle Verträge sorgfältig zu prüfen',
    'terms.limitationOfLiability': '5. Haftungsbeschränkung',
    'terms.limitationDescription':
      'Palmside S.L. haftet nicht für direkte, indirekte, zufällige, besondere oder Folgeschäden, die aus der Nutzung oder Unfähigkeit zur Nutzung unserer Dienstleistungen resultieren, einschließlich, aber nicht beschränkt auf:',
    'terms.propertyValueFluctuations': 'Schwankungen der Immobilienwerte',
    'terms.marketConditions': 'Marktbedingungen',
    'terms.thirdPartyActions': 'Handlungen oder Unterlassungen Dritter',
    'terms.technicalIssues': 'Technische Probleme oder Dienstunterbrechungen',
    'terms.intellectualProperty': '6. Geistiges Eigentum',
    'terms.intellectualPropertyDescription':
      'Alle Inhalte auf dieser Website sind Eigentum von Palmside S.L. oder werden mit Genehmigung verwendet. Die Reproduktion oder Verteilung ohne schriftliche Genehmigung ist untersagt.',
    'terms.privacyPolicy': '7. Datenschutzrichtlinie',
    'terms.privacyPolicyDescription':
      'Ihre Privatsphäre ist uns wichtig. Unsere Sammlung und Nutzung persönlicher Informationen wird durch unsere Datenschutzrichtlinie geregelt, die durch Bezugnahme in diese Nutzungsbedingungen einbezogen wird und der EU-Datenschutz-Grundverordnung (DSGVO) entspricht.',
    'terms.termination': '8. Kündigung',
    'terms.terminationDescription':
      'Wir behalten uns das Recht vor, den Zugang zu unseren Dienstleistungen ohne Vorankündigung zu beenden, wenn Sie gegen diese Bedingungen verstoßen.',
    'terms.governingLaw': '9. Anwendbares Recht',
    'terms.governingLawDescription':
      'Diese Nutzungsbedingungen werden durch und in Übereinstimmung mit den Gesetzen Spaniens und des anwendbaren Rechts der Europäischen Union ausgelegt. Streitigkeiten unterliegen der ausschließlichen Gerichtsbarkeit der Gerichte von Palma de Mallorca, Spanien.',
    'terms.contactInformation': '10. Kontaktinformationen',
    'terms.contactInformationDescription':
      'Bei Fragen zu diesen Nutzungsbedingungen kontaktieren Sie uns bitte:',
    'terms.changesToTerms': '11. Änderungen an den Bedingungen',
    'terms.changesToTermsDescription':
      'Wir behalten uns das Recht vor, diese Nutzungsbedingungen jederzeit zu ändern. Die fortgesetzte Nutzung unserer Dienstleistungen nach solchen Änderungen stellt Ihre Annahme der neuen Bedingungen dar.',

    // Additional Terms translations for sections 6-11
    'terms.intellectualPropertyText':
      'Alle Inhalte, Marken und geistiges Eigentum auf dieser Website gehören Palmside S.L. oder unseren Lizenzgebern. Sie dürfen nicht:',
    'terms.noCopyContent':
      'Unsere Inhalte ohne Erlaubnis kopieren, modifizieren oder verteilen',
    'terms.noUseTrademarks':
      'Unsere Marken oder Logos ohne Autorisierung verwenden',
    'terms.noReverseEngineer':
      'Reverse Engineering betreiben oder versuchen, Quellcode zu extrahieren',
    'terms.noRemoveNotices': 'Urheberrechts- oder Eigentumsvermerke entfernen',
    'terms.privacyDataProtection': '7. Datenschutz und Datenschutz',
    'terms.privacyDataProtectionText':
      'Ihre Privatsphäre ist uns wichtig. Unsere Sammlung und Verwendung personenbezogener Daten wird durch unsere Datenschutzrichtlinie geregelt, die durch Verweis in diese Nutzungsbedingungen einbezogen ist und der EU-Datenschutz-Grundverordnung (DSGVO) entspricht.',
    'terms.terminationText':
      'Wir behalten uns das Recht vor, Ihren Zugang zu unseren Dienstleistungen jederzeit mit oder ohne Vorankündigung aus jedem Grund, einschließlich Verletzung dieser Bedingungen, zu beenden oder zu suspendieren.',
    'terms.governingLawText':
      'Diese Nutzungsbedingungen werden durch und in Übereinstimmung mit den Gesetzen Spaniens und des anwendbaren Rechts der Europäischen Union ausgelegt. Streitigkeiten unterliegen der ausschließlichen Gerichtsbarkeit der Gerichte von Palma de Mallorca, Spanien.',
    'terms.contactInformationText':
      'Wenn Sie Fragen zu diesen Nutzungsbedingungen haben, kontaktieren Sie uns bitte:',
    'terms.address': 'Adresse:',
    'terms.changesToTermsText':
      'Wir behalten uns das Recht vor, diese Nutzungsbedingungen jederzeit zu ändern. Wir werden Benutzer über wesentliche Änderungen informieren, indem wir die aktualisierten Bedingungen auf dieser Seite veröffentlichen und das Datum "Zuletzt aktualisiert" aktualisieren.',
    ...
    'hero.endlessCoastlines': 'Mallorcas schönste Strände',
    ...
    'hero.stylishLiving': 'Stilvolle Terrassen',
    ...
    'about.story2':
      'Nach Jahren der Hilfe für Menschen bei der Navigation im Immobilienmarkt der Insel gründeten wir  Palmside, um unsere professionelle Expertise mit unserer echten Liebe zu diesem unglaublichen Ort zu verbinden.',
    'about.story3':
    ...
    // Core Values and Team sections
    'about.ourCoreValues': 'Unsere Kernwerte',
    'about.coreValuesDescription':
      'Die Prinzipien, die alles leiten, was wir tun und jede Entscheidung, die wir treffen',
    'about.value1Title': 'Kundenorientierter Ansatz',
    'about.value1Description':
      'Jede Entscheidung, die wir treffen, wird von dem geleitet, was für unsere Kunden und ihren langfristigen Erfolg am besten ist.',
    'about.value2Title': 'Exzellenz in der Ausführung',
    'about.value2Description':
      'Wir setzen hohe Standards und liefern konsequent außergewöhnliche Ergebnisse, die die Erwartungen übertreffen.',
    'about.value3Title': 'Kollaborative Partnerschaft',
    'about.value3Description':
      'Wir glauben an den Aufbau dauerhafter Beziehungen basierend auf Vertrauen, Transparenz und gegenseitigem Erfolg.',
    'about.value4Title': 'Innovation & Wachstum',
    'about.value4Description':
      'Wir entwickeln unsere Dienstleistungen kontinuierlich weiter und nutzen neue Technologien, um dem Markt voraus zu bleiben.',
    'about.meetTheTeam': 'Lernen Sie das Team kennen',
    'about.teamDescription':
      'Lokale Experten auf Mallorca, die Sie jeden Schritt des Weges begleiten',

    // Team member information
    'about.jeanettePosition': 'Gründerin/Geschäftsführerin',
    'about.jeanetteBio':
      'Ich bin eine Brückenbauerin zwischen Menschen, Märkten und Möglichkeiten – mit über 30 Jahren Erfahrung in zwei Welten: internationaler Großhandel und der Immobilienbranche. Ich habe Akademien aufgebaut, Kunden weltweit betreut, Bauprojekte koordiniert, Gewerbeimmobilien verwaltet und Eigentümergemeinschaften und Seniorenwohnanlagen geleitet. Mein Antrieb? Prozesse optimieren, Menschen verbinden und jedes Projekt zum Erfolg machen – mit Herz, Verstand und einem scharfen Auge für Details.',
    'about.claudiaPosition': 'Beratung',
    'about.claudiaBio':
      'Mit über 20 Jahren Erfahrung im internationalen Immobiliengeschäft ist Claudia eine bewährte Expertin im globalen Immobilienmarkt. Nach vielen erfolgreichen Jahren als Immobilienmaklerin in New York und New Jersey – mit Fokus auf Geschäfts- und Privatkunden – hat sie sich seit 2016 auf die D/A/D-Region, das spanische Festland und Mallorca spezialisiert. Sie arbeitet als Immobilienberaterin in diesen Märkten und unterstützt Kunden bei ihrer Suche, Bewertung und Vermittlung.',
    'about.tanerPosition': 'Technischer Direktor',
    'about.tanerBio':
      'Ich stehe seit über 30 Jahren für technische Exzellenz im Handwerk – als Senior-Elektriker auf Großbaustellen, in hochwertigen Privatresidenzen und in komplexen Industrieanlagen. Mein Fachwissen umfasst moderne Gebäudetechnologie, Photovoltaikanlagen und professionelles Facility Management mit Fokus auf Qualität, Effizienz und praktische Lösungen. Bei Palmside S.L. kombiniere ich Präzision, Effizienz und eine lösungsorientierte Denkweise, um erstklassige technische Ergebnisse zu liefern – zuverlässig und im großen Maßstab.',
    ...
    'properties.showFilters': 'Filter anzeigen',
    'properties.hideFilters': 'Filter ausblenden',
    ...
    // Property card elements
    'properties.beds': 'Schlafzimmer',
    'properties.baths': 'Badezimmer',
    'properties.sqft': 'm²',
    'properties.tryAgain': 'Erneut versuchen',

    // Property details modal
    'properties.description': 'Beschreibung',
    'properties.bedrooms': 'Schlafzimmer',
    'properties.bathrooms': 'Badezimmer',
    'properties.squareFeet': 'Quadratmeter',
    'properties.yearBuilt': 'Baujahr',
    'properties.additionalDetails': 'Zusätzliche Details',
    'properties.lotSize': 'Grundstücksgröße',
    'properties.featuresAmenities': 'Ausstattung & Annehmlichkeiten',
    'properties.interestedInProperty': 'Interessiert an dieser Immobilie?',
    'properties.contactAgent': 'Makler kontaktieren',
    'properties.sendInquiry': 'Anfrage senden',
    'properties.propertyId': 'Immobilien-ID',
    'properties.listedOn': 'Eingestellt am',
    'properties.lastUpdated': 'Zuletzt aktualisiert',
    ...
    'contact.officeDescription': 'Unser Büro in Son Verí Nou, Mallorca',
  ...
  es: {
    ...
    // Footer
    'footer.copyright': '© 2024 Palmside S.L.. Todos los derechos reservados.',
    ...
    'legal.complianceDescription':
      'Identificación de la empresa e información legal conforme a la LSSI-CE.',
    'legal.lssiCompliance': 'En cumplimiento de la LSSI-CE',
    'legal.companyIdentification': '1. Identificación de la Empresa',
    'legal.intellectualProperty': '2. Propiedad Intelectual',
    'legal.useOfWebsite': '3. Uso del Sitio Web',
    'legal.liability': '4. Responsabilidad',
    'legal.applicableLaw': '5. Ley Aplicable y Jurisdicción',
    'legal.contact': '6. Contacto',
    'legal.lastUpdated': 'Última actualización:',
    'legal.lssiDescription':
      'En cumplimiento de la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y de Comercio Electrónico (LSSI-CE), se proporciona la siguiente información.',
    'legal.companyName': 'Nombre de la empresa:',
    'legal.tradeName': 'Nombre comercial:',
    'legal.managingDirector': 'Director Gerente:',
    'legal.registeredOffice': 'Domicilio social:',
    'legal.cifNif': 'CIF/NIF:',
    'legal.commercialRegistry': 'Registro Mercantil:',
    'legal.registeredInRegistry':
      'Inscrito en el Registro Mercantil de Palma de Mallorca, Tomo [XXX], Folio [XXX], Página [XXX]',
    'legal.phone': 'Teléfono:',
    'legal.email': 'Correo electrónico:',
    'legal.address': 'Dirección:',
    'legal.intellectualPropertyDescription':
      'Todo el contenido de este sitio web (textos, imágenes, logotipos, diseños, software, etc.) es propiedad exclusiva de Palmside S.L. o de sus legítimos propietarios. La reproducción, distribución o modificación de dicho contenido sin autorización previa por escrito está estrictamente prohibida.',
    'legal.useOfWebsiteDescription':
      'Los usuarios aceptan utilizar este sitio web de acuerdo con la ley, este Aviso Legal y la buena fe. El uso del sitio web para fines que puedan dañar los derechos o intereses de terceros, o que puedan de alguna manera dañar o impedir su funcionamiento normal, está estrictamente prohibido.',
    'legal.liabilityDescription':
      'Palmside S.L. no es responsable del uso indebido de los contenidos de su sitio web, ni de daños o pérdidas derivados del acceso, uso o mal uso de la información. La empresa tampoco es responsable de la legalidad de otros sitios web de terceros que puedan ser accesibles desde este sitio.',
    'legal.applicableLawDescription':
      'Este Aviso Legal se rige por la ley española. Cualquier disputa relacionada con este sitio web será sometida a los Tribunales y Juzgados de Palma de Mallorca, con renuncia expresa a cualquier otra jurisdicción que pueda aplicarse.',
    'legal.contactDescription':
      'Para cualquier pregunta o consulta legal, puede contactarnos en:',

    // Privacy Policy
    'privacy.privacyPolicy': 'Política de Privacidad',
    'privacy.privacyDescription':
      'Su privacidad es importante para nosotros. Aprenda cómo recopilamos, usamos y protegemos su información.',
    'privacy.dataController':
      'Quiénes Somos (Responsable del Tratamiento de Datos)',
    'privacy.lastUpdated': 'Última actualización:',
    'privacy.dataControllerDescription':
      'Esta Política de Privacidad describe cómo Palmside S.L. ("nosotros", "nos", "nuestro") recopila y procesa sus datos personales cuando utiliza nuestro sitio web y aplicación o nos contacta. Palmside S.L. es el responsable del tratamiento de sus datos personales.',
    'privacy.company': 'Empresa:',
    'privacy.registeredAddress': 'Dirección registrada:',
    'privacy.phone': 'Teléfono:',
    'privacy.email': 'Correo electrónico:',
    'privacy.address': 'Dirección:',
    'privacy.informationWeCollect': '1. Información que Recopilamos',
    'privacy.informationWeCollectDescription':
      'Recopilamos información que nos proporciona directamente cuando envía el formulario de contacto, nos llama o nos envía un correo electrónico. Esto puede incluir:',
    'privacy.nameSurname': 'Nombre y apellido',
    'privacy.emailAddress': 'Dirección de correo electrónico',
    'privacy.phoneNumber': 'Número de teléfono',
    'privacy.messageContent': 'Contenido del mensaje y asunto de la consulta',
    'privacy.propertyPreferences':
      'Preferencias de propiedades opcionales o requisitos que decida compartir',
    'privacy.howWeUseInformation': '2. Cómo Utilizamos Su Información',
    'privacy.weUseInformationTo': 'Utilizamos su información para:',
    'privacy.respondToInquiries':
      'Responder a sus consultas enviadas a través del formulario de contacto, teléfono o correo electrónico',
    'privacy.provideInformation':
      'Proporcionar información solicitada sobre propiedades y servicios',
    'privacy.improveWebsite':
      'Mejorar nuestro sitio web/aplicación y soporte al cliente',
    'privacy.complyLegal': 'Cumplir con obligaciones legales y regulatorias',
    'privacy.doNotSell': 'No vendemos sus datos personales.',
    'privacy.legalBases': '3. Bases Legales (GDPR)',
    'privacy.legalBasesDescription':
      'Procesamos sus datos personales bajo las siguientes bases legales (GDPR Art. 6):',
    'privacy.consent': 'Consentimiento',
    'privacy.consentDescription':
      'cuando envía el formulario de contacto o solicita una devolución de llamada.',
    'privacy.legitimateInterests': 'Intereses legítimos',
    'privacy.legitimateInterestsDescription':
      'para responder a sus consultas y operar nuestro negocio.',
    'privacy.legalObligation': 'Obligación legal',
    'privacy.legalObligationDescription':
      'donde el procesamiento es necesario para cumplir con las leyes aplicables.',
    'privacy.informationSharing': '4. Compartir Información',
    'privacy.informationSharingDescription':
      'No vendemos su información personal. Podemos compartir su información solo cuando sea necesario:',
    'privacy.serviceProviders':
      'Con proveedores de servicios de confianza (por ejemplo, hosting, entrega de correo electrónico) actuando como procesadores',
    'privacy.requiredByLaw':
      'Cuando sea requerido por ley, orden judicial o autoridad pública',
    'privacy.corporateTransactions':
      'En conexión con transacciones corporativas (fusión, adquisición) sujeto a salvaguardas',
    'privacy.explicitConsent': 'Con su consentimiento explícito',
    'privacy.dataRetention': '5. Retención de Datos',
    'privacy.dataRetentionDescription':
      'Retenemos sus datos personales solo durante el tiempo necesario para responder a su consulta y por un período razonable después para mantener registros y cumplir con obligaciones legales. Eliminamos o anonimizamos datos cuando ya no son necesarios.',
    'privacy.dataSecurity': '6. Seguridad de Datos',
    'privacy.dataSecurityDescription':
    ...
    'privacy.internationalTransfersDescription':
      'Si los datos personales se transfieren fuera de la UE/EEE, nos aseguraremos de que existan salvaguardas apropiadas (por ejemplo, Cláusulas Contractuales Estándar de la UE) y que sus derechos permanezcan protegidos.',
    'privacy.yourRights': '8. Sus Derechos (GDPR)',
    'privacy.youHaveRightTo': 'Usted tiene derecho a:',
    'privacy.accessUpdate': 'Acceder y actualizar su información personal',
    'privacy.requestDeletion':
      'Solicitar la eliminación de su información personal',
    'privacy.optOutMarketing':
      'Optar por no recibir comunicaciones de marketing',
    'privacy.requestCopy': 'Solicitar una copia de sus datos',
    'privacy.withdrawConsent': 'Retirar el consentimiento en cualquier momento',
    'privacy.restrictObject':
      'Restringir u oponerse al procesamiento en ciertas circunstancias',
    'privacy.exerciseRights': 'Para ejercer sus derechos, contáctenos en',
    'privacy.lodgeComplaint':
      'También tiene derecho a presentar una queja ante su autoridad local de protección de datos. En España, esta es la Agencia Española de Protección de Datos (AEPD).',
    'privacy.cookiesTracking': '9. Cookies y Seguimiento',
    'privacy.cookiesTrackingDescription':
      'Utilizamos cookies y tecnologías de seguimiento similares para mejorar su experiencia en nuestro sitio web. Puede controlar la configuración de cookies a través de las preferencias de su navegador.',
    'privacy.contactUs': '10. Contáctenos',
    'privacy.contactUsDescription':
      'Si tiene alguna pregunta sobre esta Política de Privacidad, contáctenos:',
    'privacy.changesToPolicy': '11. Cambios a Esta Política',
    'privacy.changesToPolicyDescription':
    ...
    'terms.companyDetails': 'Detalles de la Empresa',
    'terms.lastUpdated': 'Última actualización:',
    'terms.company': 'Empresa:',
    'terms.registeredAddress': 'Dirección registrada:',
    'terms.phone': 'Teléfono:',
    'terms.email': 'Correo electrónico:',
    'terms.acceptanceOfTerms': '1. Aceptación de los Términos',
    'terms.acceptanceDescription':
      'Al acceder y utilizar los servicios de Palmside S.L., acepta y se compromete a cumplir con los términos y disposiciones de este acuerdo. Si no está de acuerdo con lo anterior, no utilice este servicio.',
    'terms.descriptionOfService': '2. Descripción del Servicio',
    'terms.descriptionOfServiceText':
      'Palmside S.L. proporciona servicios inmobiliarios que incluyen, pero no se limitan a:',
    'terms.propertySales': 'Ventas y compras de propiedades',
    'terms.investmentConsulting': 'Consultoría de inversiones',
    'terms.propertyManagement': 'Gestión de propiedades',
    'terms.marketAnalysis': 'Análisis de mercado',
    'terms.legalSupport': 'Apoyo legal y orientación',
    'terms.userResponsibilities': '3. Responsabilidades del Usuario',
    'terms.userResponsibilitiesText':
      'Como usuario de nuestros servicios, acepta:',
    'terms.provideAccurateInfo': 'Proporcionar información precisa y completa',
    'terms.lawfulPurposes':
      'Utilizar nuestros servicios solo para fines legales',
    'terms.respectRights': 'Respetar los derechos de otros usuarios',
    'terms.noFraudulent': 'No participar en prácticas fraudulentas o engañosas',
    'terms.complyLaws': 'Cumplir con todas las leyes y regulaciones aplicables',
    'terms.propertyInformation': '4. Información de Propiedades',
    'terms.propertyInformationText':
      'Aunque nos esforzamos por proporcionar información precisa sobre propiedades, no podemos garantizar la integridad o precisión de todos los detalles de las propiedades. La información de las propiedades está sujeta a cambios sin previo aviso. Recomendamos:',
    'terms.verifyDetails':
      'Verificar todos los detalles de la propiedad independientemente',
    'terms.conductInspections': 'Realizar sus propias inspecciones',
    'terms.consultAdvisors': 'Consultar con asesores legales y financieros',
    'terms.reviewContracts': 'Revisar todos los contratos cuidadosamente',
    'terms.limitationOfLiability': '5. Limitación de Responsabilidad',
    'terms.limitationDescription':
      'Palmside S.L. no será responsable por daños directos, indirectos, incidentales, especiales o consecuenciales que resulten del uso o la imposibilidad de usar nuestros servicios, incluyendo pero no limitado a:',
    'terms.propertyValueFluctuations':
      'Fluctuaciones del valor de las propiedades',
    'terms.marketConditions': 'Condiciones del mercado',
    'terms.thirdPartyActions': 'Acciones u omisiones de terceros',
    'terms.technicalIssues': 'Problemas técnicos o interrupciones del servicio',
    'terms.intellectualProperty': '6. Propiedad Intelectual',
    'terms.intellectualPropertyDescription':
      'Todo el contenido en este sitio web es propiedad de Palmside S.L. o se usa con permiso. La reproducción o distribución sin autorización escrita está prohibida.',
    'terms.privacyPolicy': '7. Política de Privacidad',
    'terms.privacyPolicyDescription':
      'Su privacidad es importante para nosotros. Nuestra recopilación y uso de información personal se rige por nuestra Política de Privacidad, que se incorpora a estos Términos de Servicio por referencia y cumple con el Reglamento General de Protección de Datos de la UE (GDPR).',
    'terms.termination': '8. Terminación',
    'terms.terminationDescription':
      'Nos reservamos el derecho de terminar el acceso a nuestros servicios sin previo aviso si viola estos términos.',
    'terms.governingLaw': '9. Ley Aplicable',
    'terms.governingLawDescription':
      'Estos Términos de Servicio se rigen e interpretan de acuerdo con las leyes de España y la ley aplicable de la Unión Europea. Las disputas estarán sujetas a la jurisdicción exclusiva de los tribunales de Palma de Mallorca, España.',
    'terms.contactInformation': '10. Información de Contacto',
    'terms.contactInformationDescription':
      'Si tiene preguntas sobre estos Términos de Servicio, contáctenos:',
    'terms.changesToTerms': '11. Cambios a los Términos',
    'terms.changesToTermsDescription':
      'Nos reservamos el derecho de modificar estos Términos de Servicio en cualquier momento. El uso continuado de nuestros servicios después de dichos cambios constituye su aceptación de los nuevos términos.',

    // Additional Terms translations for sections 6-11
    'terms.intellectualPropertyText':
      'Todo el contenido, marcas comerciales y propiedad intelectual en este sitio web son propiedad de Palmside S.L. o nuestros licenciantes. No puede:',
    'terms.noCopyContent':
      'Copiar, modificar o distribuir nuestro contenido sin permiso',
    'terms.noUseTrademarks':
      'Usar nuestras marcas comerciales o logotipos sin autorización',
    'terms.noReverseEngineer':
      'Hacer ingeniería inversa o intentar extraer código fuente',
    'terms.noRemoveNotices': 'Eliminar avisos de derechos de autor o propiedad',
    'terms.privacyDataProtection': '7. Privacidad y Protección de Datos',
    'terms.privacyDataProtectionText':
      'Su privacidad es importante para nosotros. Nuestra recopilación y uso de información personal se rige por nuestra Política de Privacidad, que se incorpora a estos Términos de Servicio por referencia y cumple con el Reglamento General de Protección de Datos de la UE (GDPR).',
    'terms.terminationText':
      'Nos reservamos el derecho de terminar o suspender su acceso a nuestros servicios en cualquier momento, con o sin previo aviso, por cualquier razón, incluyendo la violación de estos términos.',
    'terms.governingLawText':
      'Estos Términos de Servicio se rigen e interpretan de acuerdo con las leyes de España y la ley aplicable de la Unión Europea. Las disputas estarán sujetas a la jurisdicción exclusiva de los tribunales de Palma de Mallorca, España.',
    'terms.contactInformationText':
    ...
    'terms.changesToTermsText':
      'Nos reservamos el derecho de modificar estos Términos de Servicio en cualquier momento. Notificaremos a los usuarios de cualquier cambio material publicando los términos actualizados en esta página y actualizando la fecha de "Última actualización".',
    ...
    'hero.endlessCoastlines': 'Las mejores playas de Mallorca',
    ...
    'hero.terracePool': 'Piscinas exteriores',
    ...
    'hero.stylishLiving': 'Terrazas con estilo',
    ...
    // Page Banners
    'banner.about': 'Acerca de  Palmside',
    'banner.aboutSubtitle':
    ...
    'about.story2':
      'Después de años ayudando a las personas a navegar el mercado inmobiliario de la isla, fundamos  Palmside para combinar nuestra experiencia profesional con nuestro genuino amor por este lugar increíble.',
    'about.story3':
    ...
    // Core Values and Team sections
    'about.ourCoreValues': 'Nuestros Valores Fundamentales',
    'about.coreValuesDescription':
      'Los principios que guían todo lo que hacemos y cada decisión que tomamos',
    'about.value1Title': 'Enfoque Centrado en el Cliente',
    'about.value1Description':
      'Cada decisión que tomamos está guiada por lo que es mejor para nuestros clientes y su éxito a largo plazo.',
    'about.value2Title': 'Excelencia en la Ejecución',
    'about.value2Description':
      'Establecemos altos estándares y entregamos consistentemente resultados excepcionales que superan las expectativas.',
    'about.value3Title': 'Asociación Colaborativa',
    'about.value3Description':
      'Creemos en construir relaciones duraderas basadas en la confianza, la transparencia y el éxito mutuo.',
    'about.value4Title': 'Innovación y Crecimiento',
    'about.value4Description':
      'Evolucionamos continuamente nuestros servicios y adoptamos nuevas tecnologías para mantenernos a la vanguardia del mercado.',
    'about.meetTheTeam': 'Conozca al Equipo',
    'about.teamDescription':
      'Expertos locales en Mallorca guiándole en cada paso del camino',

    // Team member information
    'about.jeanettePosition': 'Fundadora/Directora Ejecutiva',
    'about.jeanetteBio':
      'Soy una constructora de puentes entre personas, mercados y oportunidades – con más de 30 años de experiencia en dos mundos: el comercio mayorista internacional y la industria inmobiliaria. He construido academias, atendido clientes en todo el mundo, coordinado proyectos de construcción, gestionado propiedades comerciales y administrado asociaciones de propietarios y comunidades de jubilados. ¿Mi impulso? Optimizar procesos, conectar personas y hacer que cada proyecto sea un éxito – con corazón, mente y un ojo agudo para los detalles.',
    'about.claudiaPosition': 'Consultoría',
    'about.claudiaBio':
      'Con más de 20 años de experiencia en el negocio inmobiliario internacional, Claudia es una experta probada en el mercado inmobiliario global. Después de muchos años exitosos como agente inmobiliaria en Nueva York y Nueva Jersey – enfocándose en clientes comerciales y privados – se ha especializado en la región D/A/D, España peninsular y Mallorca desde 2016. Trabaja como consultora inmobiliaria en estos mercados, apoyando a los clientes con su búsqueda, valoración y corretaje.',
    'about.tanerPosition': 'Director Técnico',
    'about.tanerBio':
      'He defendido la excelencia técnica en oficios especializados durante más de 30 años – como electricista senior en obras de construcción a gran escala, en residencias privadas de alta gama y en proyectos industriales complejos. Mi experiencia abarca tecnología de construcción moderna, sistemas fotovoltaicos y gestión profesional de instalaciones, con un enfoque en calidad, eficiencia y soluciones prácticas. En Palmside S.L., combino precisión, eficiencia y una mentalidad de resolución de problemas para entregar resultados técnicos de primer nivel – de manera confiable y a escala.',
    ...
    'properties.showFilters': 'Mostrar Filtros',
    'properties.hideFilters': 'Ocultar Filtros',
    ...
    'properties.sqft': 'm²',
    'properties.tryAgain': 'Intentar de nuevo',

    // Property details modal
    'properties.description': 'Descripción',
    'properties.bedrooms': 'Dormitorios',
    'properties.bathrooms': 'Baños',
    'properties.squareFeet': 'Metros Cuadrados',
    'properties.yearBuilt': 'Año de Construcción',
    'properties.additionalDetails': 'Detalles Adicionales',
    'properties.lotSize': 'Tamaño del Lote',
    'properties.featuresAmenities': 'Características y Comodidades',
    'properties.interestedInProperty': '¿Interesado en esta propiedad?',
    'properties.contactAgent': 'Contactar Agente',
    'properties.sendInquiry': 'Enviar Consulta',
    'properties.propertyId': 'ID de Propiedad',
    'properties.listedOn': 'Listado el',
    'properties.lastUpdated': 'Última actualización',

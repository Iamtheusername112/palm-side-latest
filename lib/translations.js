...
export const translations = {
  en: {
    ...
    'terms.acceptanceDescription':
      'By accessing and using Palmside Real Estate services, you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.',
    'terms.descriptionOfService': '2. Description of Service',
    'terms.descriptionOfServiceText':
      'Palmside Real Estate provides real estate services including but not limited to:',
    ...
    'terms.limitationDescription':
      'Palmside Real Estate shall not be liable for any direct, indirect, incidental, special, or consequential damages resulting from the use or inability to use our services, including but not limited to:',
    ...
    'terms.intellectualPropertyText':
      'All content, trademarks, and intellectual property on this website are owned by Palmside Real Estate or our licensors. You may not:',
    'terms.noCopyContent':
  ...
  de: {
    ...
    'terms.acceptanceDescription':
      'Durch den Zugriff auf und die Nutzung der Palmside Real Estate Dienstleistungen akzeptieren und stimmen Sie zu, an die Bedingungen und Bestimmungen dieser Vereinbarung gebunden zu sein. Wenn Sie nicht zustimmen, sich an das oben Genannte zu halten, nutzen Sie bitte diesen Service nicht.',
    'terms.descriptionOfService': '2. Beschreibung des Services',
    'terms.descriptionOfServiceText':
      'Palmside Real Estate bietet Immobiliendienstleistungen an, einschließlich, aber nicht beschränkt auf:',
    ...
    'terms.limitationDescription':
      'Palmside Real Estate haftet nicht für direkte, indirekte, zufällige, besondere oder Folgeschäden, die aus der Nutzung oder Unfähigkeit zur Nutzung unserer Dienstleistungen resultieren, einschließlich, aber nicht beschränkt auf:',
    ...
    // Additional Terms translations for sections 6-11
    'terms.intellectualPropertyText':
      'Alle Inhalte, Marken und geistiges Eigentum auf dieser Website gehören Palmside Real Estate oder unseren Lizenzgebern. Sie dürfen nicht:',
    'terms.noCopyContent':
  ...
  es: {
    ...
    'terms.acceptanceDescription':
      'Al acceder y utilizar los servicios de Palmside Real Estate, acepta y se compromete a cumplir con los términos y disposiciones de este acuerdo. Si no está de acuerdo con lo anterior, no utilice este servicio.',
    'terms.descriptionOfService': '2. Descripción del Servicio',
    'terms.descriptionOfServiceText':
      'Palmside Real Estate proporciona servicios inmobiliarios que incluyen, pero no se limitan a:',
    ...
    'terms.limitationDescription':
      'Palmside Real Estate no será responsable por daños directos, indirectos, incidentales, especiales o consecuenciales que resulten del uso o la imposibilidad de usar nuestros servicios, incluyendo pero no limitado a:',
    ...
    // Additional Terms translations for sections 6-11
    'terms.intellectualPropertyText':
      'Todo el contenido, marcas comerciales y propiedad intelectual en este sitio web son propiedad de Palmside Real Estate o nuestros licenciantes. No puede:',
    'terms.noCopyContent':
